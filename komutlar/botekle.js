...
exports.run = function(client, message, args) {
  ...
  .setColor("PURPLE")
  .setDescription(`<a:yldz:824606635669848064> ${message.author} adlı kullanıcının <@${botid}> adlı botu sıraya ekledi. Botu onaylanmayı bekliyor. `)
  ...
  message.channel.send(` <a:yldz:824606635669848064> Bot ekleme isteğiniz alındı.`).then(msg => msg.delete(1000))
  }
};
////fiber botlist & code
exports.conf = {
