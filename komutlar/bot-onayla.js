...
exports.run = function(client, message, args) {
  ...
  .setColor("GREEN")
  .setDescription(`<a:yldz:824606635669848064> <@${sahip}> adlı kişinin <@${botisim}> adlı botu onaylandı.\nOnaylayan yetkili : ${message.author}`)
  ...
  message.channel.send(`<a:yldz:824606635669848064> Botu onayladınız.`).then(msg => msg.delete(1000))
