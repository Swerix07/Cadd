...
exports.run = async (bot, message, args) => {
  ...
  const istatistikler = new Discord.MessageEmbed()
    ...
    .addField('Producer', '<@823553491162497084>')
        .addField("**Links**", "[İnvite Bot](https://discord.com/oauth2/authorize?client_id=824558056385150996&scope=bot&permissions=805314622)\n[Support Server](https://discord.gg/y3R9sTYQQs)") 
